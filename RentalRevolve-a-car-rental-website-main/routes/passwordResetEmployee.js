...
router.post("/", async (req, res) => {
	try {
		...
		const url = `http://localhost:3000/password-reset-employee/${user._id}/employee/${token.token}/`;
...
router.get("/:id/employee/:token", async (req, res) => {
	try {
...
//  set new password
router.post("/:id/employee/:token", async (req, res) => {
	try {
