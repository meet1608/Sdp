...
router.post("/", async (req, res) => {
	try {
		...
		const url = `http://localhost:3000/password-reset-seller/${user._id}/seller/${token.token}/`;
...
router.get("/:id/seller/:token", async (req, res) => {
	try {
...
//  set new password
router.post("/:id/seller/:token", async (req, res) => {
	try {
